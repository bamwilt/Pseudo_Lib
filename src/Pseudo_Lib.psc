...
Funcion main
	...
	sprite = SpriteString_AddLine(sprite, ":¯;     _  ____   _. ._ __  __"); 
...
Funcion canvas_Result <- canvas_DrawPanel(canvas, Cx, Cy, x0, y0, width, heigth)
	...
	canvas_Result = canvas_DrawPoint_pixel(canvas_Result, Cx, Cy, "×", x0, heigth);
	width = decrement(width);
	canvas_Result = canvas_DrawPoint_pixel(canvas_Result, Cx, Cy, "×", width, heigth);
