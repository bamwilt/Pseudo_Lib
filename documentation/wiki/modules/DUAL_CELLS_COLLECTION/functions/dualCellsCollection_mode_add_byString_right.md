# dualCellsCollection_mode_add_byString_right

**Módulo:** [DUAL_CELLS_COLLECTION](../DUAL_CELLS_COLLECTION.md)

## Descripción
Agrega un elemento al lado derecho según el modo de inserción, validando la longitud si es necesario.
...
## Retorna
La estructura con el elemento agregado.
