# dualCellsCollection_getCell_left_toType

**Módulo:** [DUAL_CELLS_COLLECTION](../DUAL_CELLS_COLLECTION.md)

## Descripción
Obtiene la celda izquierda en un índice y la convierte al tipo especificado.
...
- `TYPE`: Tipo al que convertir el valor

## Retorna
Valor de la celda convertido al tipo especificado.
